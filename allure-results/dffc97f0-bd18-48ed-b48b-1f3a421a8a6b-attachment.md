...
Locator: locator('//a[normalize-space()=\'sample.pdf\']')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('//a[normalize-space()=\'sample.pdf\']')

    at C:\Users\ashwin.murugan\playwrite -training\playwrightdemo\tests\PracticeTestCases\30_UploadFilePractice.spec.js:23:71
```
...
- paragraph:
  - link "ads via Carbon":
    - /url: https://srv.carbonads.net/ads/click/x/GTND427WCAADC2QEFTALYKQUCESI627WCY7DKZ3JCABD523JCEBI52QKC6YDC2JICWSIV27MC6SI653UFTADC27KC6SIV27YCVYIKK3EHJNCLSIZ
    - img "ads via Carbon"
  - link "All the connections, zero limits. Unlimited Okta and social connections on our Free Plan. Sign up →":
    - /url: https://srv.carbonads.net/ads/click/x/GTND427WCAADC2QEFTALYKQUCESI627WCY7DKZ3JCABD523JCEBI52QKC6YDC2JICWSIV27MC6SI653UFTADC27KC6SIV27YCVYIKK3EHJNCLSIZ
  - link "ads via Carbon":
...
```ts
  ...
  21 |     await page.locator("//span[normalize-space()='Start upload']").click();
  22 |     await page.waitForTimeout(5000)
> 23 |     await expect(page.locator("//a[normalize-space()='sample.pdf']")).toBeVisible();
     |                                                                       ^ Error: Timed out 5000ms waiting for expect(locator).toBeVisible()
  24 | })
```