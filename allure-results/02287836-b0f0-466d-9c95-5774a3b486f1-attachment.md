...
Locator: locator('//a[normalize-space()=\'Screenshot (2).png\']')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('//a[normalize-space()=\'Screenshot (2).png\']')

    at C:\Users\ashwin.murugan\playwrite -training\playwrightdemo\tests\PracticeTestCases\30_UploadFilePractice.spec.js:23:79
```
...
- paragraph:
  - link "ads via Carbon":
    - /url: https://srv.carbonads.net/ads/click/x/GTND427WCAADC2QLCWYLYKQUCESI65QWCA7ITZ3JCABD523IC6SI453KC6YDC2JICWSIV27MC6SI653UFTBI453KC6SIV27YCVYIKK3EHJNCLSIZ
    - img "ads via Carbon"
...
```ts
  ...
  21 |     await page.locator("//*[@id='fileupload']/div/div[1]/span[1]/input").click();
