...
```
Error: locator.click: Error: strict mode violation: getByText('SpicePlus') resolved to 2 elements:
    1) <div dir="auto" class="css-76zvg2 r-homxoj r-ubezar">SpicePlus</div> aka getByTestId('test-id-SpicePlus')
    2) <div dir="auto" class="css-76zvg2 r-c20mna r-evnaw r-1kfrs79 r-1sp51qo r-ilng1c">SpicePlus</div> aka getByRole('link', { name: 'SpicePlus Enjoy priority' })

Call log:
  - waiting for getByText('SpicePlus')

    at C:\Users\ashwin.murugan\playwrite -training\playwrightdemo\tests\PracticeTestCases\26_MouseHover.spec.js:33:19
```
...
- link "International Connection Baggage":
  - /url: https://corporate.spicejet.com/IntlConnBaggage.aspx
- link "Taxi":
...
- link "Travel Assistance Services":
...
- link "Zero Cancellation":
  - /url: https://corporate.spicejet.com/ZeroCancellation.aspx
- link "Zero Cancellation - International":
...
- link "Taxi":
  - /url: https://spicejet.bookairportcab.com/?SJ1
- link "Cargo":
...
- text: Departure Date Wed, 28 May 2025
- img
...
- text: Search Flight Effective March 30, 2025, summer schedule changes may impact flight timings. Please check the
- link "Manage Booking":
  - /url: https://www.spicejet.com/#manage-booking
- text: tab for updates. Use our
- link "Change Assist":
...
- link "Spin to Win":
  ...
  - link:
    - /url: ""
- text: Irresistible Deals SpiceMax The best seat in the sky at 30% Off SMAX30 Valid till:June 30, 2025 Enjoy ADDONS at Upto 25% Off ADDON25 Valid till:June 30, 2025 KWIK CASHBACKS get Flat ₹200 Cashback SPJMBK Valid till:June 30, 2025 Explore More Recommended Add-Ons
...
- link "Excess Baggage Avoid last-minute baggage hassles at the airport by pre-booking your excess baggage now and save up to 10%!":
  - /url: https://corporate.spicejet.com/ExcessBaggage.aspx
- link "You1st Enjoy Priority Check-in, Boarding & Baggage Delivery for just ₹499/₹699 (Domestic/International)!":
  - /url: https://corporate.spicejet.com/YouFirst.aspx
...
- text: "Note: We log the IP addresses of the visitors on our website for security reasons. © Copyright Spicejet India. All Rights Reserved Registered Office: SpiceJet Ltd, 319, Udyog Vihar, Phase IV, Gurgaon, Haryana - 122016"
- link "Home":
  - /url: /
- text: •
- link "Privacy Policy":
...
```ts
  ...
  28 |   await page.goto("https://www.spicejet.com/");
  29 |   const addon = page.locator("//div[contains(text(),'Add-ons')]");
  30 |   const spiceplus = page.getByText("SpicePlus");
  31 |
  32 |   await addon.hover();
> 33 |   await spiceplus.click();
     |                   ^ Error: locator.click: Error: strict mode violation: getByText('SpicePlus') resolved to 2 elements:
  34 | });
  35 |
```