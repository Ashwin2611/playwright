...
Call log:
  ...
  - waiting for locator('#multipleFilesStatus')
    ...
    at C:\Users\ashwin.murugan\playwrite -training\playwrightdemo\tests\PracticeTestCases\29_UploadFile.spec.js:22:54
```
...
- table:
  - rowgroup:
    - row "Name Disk (MB/s) Memory (MB) CPU (%) Network (Mbps)":
      ...
      - cell "Network (Mbps)"
  - rowgroup:
    - row "Firefox 0.82 MB/s 84.0 MB 3.2% 4.9 Mbps":
      - cell "Firefox"
      - cell "0.82 MB/s"
      - cell "84.0 MB"
      - cell "3.2%"
      - cell "4.9 Mbps"
    - row "Internet Explorer 0.13 MB/s 79.9 MB 2.6% 1.7 Mbps":
      - cell "Internet Explorer"
      - cell "0.13 MB/s"
      - cell "79.9 MB"
      - cell "2.6%"
      - cell "1.7 Mbps"
    - row "System 0.81 MB/s 78.7 MB 7.3% 8.8 Mbps":
      - cell "System"
      - cell "0.81 MB/s"
      - cell "78.7 MB"
      - cell "7.3%"
      - cell "8.8 Mbps"
    - row "Chrome 0.84 MB/s 57.6 MB 4.9% 8.2 Mbps":
      - cell "Chrome"
      - cell "0.84 MB/s"
      - cell "57.6 MB"
      - cell "4.9%"
...
```ts
  ...
  20 |     "index.html"
  21 |   );
> 22 |   await expect(page.locator("#multipleFilesStatus")).toContainText(
     |                                                      ^ Error: Timed out 5000ms waiting for expect(locator).toContainText(expected)
  23 |     "index2.html"
  24 |   );
  25 |
